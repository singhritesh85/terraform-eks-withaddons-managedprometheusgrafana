# Using this terraform script it is possible to create the EKS Cluster with Add ons namely VPC-CNI, EBS-CSI driver, coredns, kube-proxy, Gurad-Duty for Dev, Stage and Prod Environment
