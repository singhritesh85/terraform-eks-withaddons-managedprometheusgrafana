...
#  eks_ami_id = var.eks_ami_id
  ...
  service_account_name = var.service_account_name      ###"${var.service_account_name}-${var.env[0]}"
  grafana_namespace    = var.grafana_namespace         ###"${var.grafana_namespace}-${var.env[0]}"
  prometheus_namespace = var.prometheus_namespace      ###"${var.prometheus_namespace}-${var.env[0]}"
  prometheus_workspace_alias = "${var.prometheus_workspace_alias}-${var.env[0]}"

  
  grafana_workspace_name = "${var.grafana_workspace_name}-${var.env[0]}"
